...
class Trainer(abc.ABC):
    ...
    def fit(
        ...
        for epoch in range(num_epochs):
            ...
            max_train_acc = max(max_train_acc, train_result.accuracy)
            min_train_loss = min(min_train_loss, np.mean(train_result.losses))
            max_test_acc = max(max_test_acc, test_result.accuracy)
            min_test_loss = min(min_test_loss, np.mean(test_result.losses))
